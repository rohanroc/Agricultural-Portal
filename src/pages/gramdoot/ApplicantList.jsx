  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-grow max-w-7xl mx-auto w-full px-3 sm:px-4 md:px-6 py-6 sm:py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:flex-wrap items-stretch sm:items-end gap-3 mb-6">
          {[
            ...
            <div key={key} className="flex flex-col gap-1 w-full sm:w-44">
              ...
              <input
                ...
                className="border border-gray-300 rounded px-3 py-2 text-sm w-full focus:outline-none focus:border-[#0891b2] focus:ring-1 focus:ring-[#0891b2]"
              />
            </div>
          ))}
          ...
          <div className="flex gap-2 w-full sm:w-auto">
            <button
              ...
              className="flex-1 sm:flex-none bg-[#1565c0] hover:bg-[#1253a0] text-white text-sm font-medium px-4 py-2 rounded transition-colors"
            >
              Search
            </button>
            <button
              onClick={handleReset}
              className="flex-1 sm:flex-none bg-gray-500 hover:bg-gray-600 text-white text-sm font-medium px-4 py-2 rounded transition-colors"
            >
              Reset
            </button>
          </div>
        ...
        {/* ── Table ── */}
        <h3 className="text-[#0891b2] font-semibold text-xs sm:text-sm mb-3">
                  ...
                  >
                    ...
                    <td className="px-3 py-2 text-center">
                      <button
                        ...
                        className="text-[#0891b2] hover:underline font-mono text-xs break-all"
                      >
                        {row.ackId}
                      </button>
                    </td>
        ...
        {/* ── Pagination ── */}
        {filtered.length > 0 && (
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mt-4 gap-3 text-xs sm:text-sm text-gray-600">
            <span>
            ...
            <div className="flex flex-wrap items-center gap-1">
              ...
              {visiblePages().map((p) => (
                <button
                  key={p}
                  onClick={() => goPage(p)}
                  className={`px-2.5 py-1 text-xs border rounded ${p === page
